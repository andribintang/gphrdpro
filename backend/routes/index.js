...
const Product = sequelize.define('ErpProduct', {
  ...
  store_images:        { type: DataTypes.JSON, allowNull: true, defaultValue: null },
  store_variants:      { type: DataTypes.JSON, allowNull: true, defaultValue: null },
  store_short_desc:    { type: DataTypes.STRING(500), allowNull: true },
  store_description:   { type: DataTypes.TEXT, allowNull: true },
  store_tags:          { type: DataTypes.JSON, allowNull: true, defaultValue: null },
