    ...
    children: [
      ...
      },
      {
        ...
        items:[
          ...
          { to:'/erp/master',       icon:Database,      label:'Master Data', roles:['admin','hr'] },
          ...
          { to:'/erp/shipments',    icon:Truck,         label:'Pengiriman',  roles:['admin','hr','supervisor'] },
        ],
      },
      {
        ...
        items:[
          ...
          { to:'/erp/report-channel',icon:LayoutList,  label:'Laporan Channel', roles:['admin','hr'] },
        ],
      },
    ],
  },
